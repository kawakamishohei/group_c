...
class Timetable(models.Model):
    ...
    FirstPeriod = models.ForeignKey(Subject, on_delete=models.PROTECT, verbose_name='１時間目', related_name='FirstPeriod',default=1)
    firsttext = models.CharField('授業内容', max_length=30, default="")
    SecondPeriod = models.ForeignKey(Subject, on_delete=models.PROTECT, verbose_name='２時間目', related_name='SecondPeriod', default=2)
    secondtext = models.CharField('授業内容', max_length=30, default="")
    ThirdPeriod = models.ForeignKey(Subject, on_delete=models.PROTECT, verbose_name='３時間目', related_name='ThirdPeriod', default=3)
    thirdtext = models.CharField('授業内容', max_length=30, default="")
    FourthPeriod = models.ForeignKey(Subject, on_delete=models.PROTECT, verbose_name='４時間目', related_name='FourthPeriod', default=4)
    fourthtext = models.CharField('授業内容', max_length=30, default="")
    FifthPeriod = models.ForeignKey(Subject, on_delete=models.PROTECT, verbose_name='５時間目', related_name='FifthPeriod', default=5)
    fifthtext = models.CharField('授業内容', max_length=30, default="")
    SixthPeriod = models.ForeignKey(Subject, on_delete=models.PROTECT, verbose_name='６時間目', related_name='SixthPeriod', default=6)
